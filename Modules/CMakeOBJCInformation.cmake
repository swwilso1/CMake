...
if(NOT CMAKE_SHARED_LIBRARY_CREATE_OBJC_FLAGS)
  set(CMAKE_SHARED_LIBRARY_CREATE_OBJC_FLAGS ${CMAKE_SHARED_LIBRARY_CREATE_C_FLAGS})
endif()

if(NOT CMAKE_OBJC_COMPILE_OPTIONS_PIC)
  set(CMAKE_OBJC_COMPILE_OPTIONS_PIC ${CMAKE_C_COMPILE_OPTIONS_PIC})
endif()

if(NOT CMAKE_OBJC_COMPILE_OPTIONS_PIE)
  set(CMAKE_OBJC_COMPILE_OPTIONS_PIE ${CMAKE_C_COMPILE_OPTIONS_PIE})
endif()

if(NOT CMAKE_OBJC_COMPILE_OPTIONS_DLL)
  set(CMAKE_OBJC_COMPILE_OPTIONS_DLL ${CMAKE_C_COMPILE_OPTIONS_DLL})
endif()

if(NOT CMAKE_SHARED_LIBRARY_OBJC_FLAGS)
  set(CMAKE_SHARED_LIBRARY_OBJC_FLAGS ${CMAKE_SHARED_LIBRARY_C_FLAGS})
endif()

if(NOT DEFINED CMAKE_SHARED_LIBRARY_LINK_OBJC_FLAGS)
  set(CMAKE_SHARED_LIBRARY_LINK_OBJC_FLAGS ${CMAKE_SHARED_LIBRARY_LINK_C_FLAGS})
endif()

if(NOT CMAKE_SHARED_LIBRARY_RUNTIME_OBJC_FLAG)
  set(CMAKE_SHARED_LIBRARY_RUNTIME_OBJC_FLAG ${CMAKE_SHARED_LIBRARY_RUNTIME_C_FLAG})
endif()

if(NOT CMAKE_SHARED_LIBRARY_RUNTIME_OBJC_FLAG_SEP)
  set(CMAKE_SHARED_LIBRARY_RUNTIME_OBJC_FLAG_SEP ${CMAKE_SHARED_LIBRARY_RUNTIME_C_FLAG_SEP})
endif()

if(NOT CMAKE_SHARED_LIBRARY_RPATH_LINK_OBJC_FLAG)
  set(CMAKE_SHARED_LIBRARY_RPATH_LINK_OBJC_FLAG ${CMAKE_SHARED_LIBRARY_RPATH_LINK_C_FLAG})
endif()

if(NOT DEFINED CMAKE_EXE_EXPORTS_OBJC_FLAG)
  set(CMAKE_EXE_EXPORTS_OBJC_FLAG ${CMAKE_EXE_EXPORTS_C_FLAG})
endif()

if(NOT DEFINED CMAKE_SHARED_LIBRARY_SONAME_OBJC_FLAG)
  set(CMAKE_SHARED_LIBRARY_SONAME_OBJC_FLAG ${CMAKE_SHARED_LIBRARY_SONAME_C_FLAG})
endif()
...
if(NOT DEFINED CMAKE_SHARED_LIBRARY_LINK_OBJC_WITH_RUNTIME_PATH)
  set(CMAKE_SHARED_LIBRARY_LINK_OBJC_WITH_RUNTIME_PATH ${CMAKE_SHARED_LIBRARY_LINK_C_WITH_RUNTIME_PATH})
endif()
...
if(NOT CMAKE_INCLUDE_FLAG_SEP_OBJC)
  set(CMAKE_INCLUDE_FLAG_SEP_OBJC ${CMAKE_INCLUDE_FLAG_SEP_C})
endif()
