...
#
# CHECK_OBJCXX_SOURCE_COMPILES(<code> <var> [FAIL_REGEX <fail-regex>])
#
# ::
#
...
#=============================================================================
# Copyright 2005-2014 Kitware, Inc.
#
  ...
  if("${VAR}" MATCHES "^${VAR}$")
    ...
    if(${VAR})
      ...
      file(APPEND ${CMAKE_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/CMakeOutput.log
        "Performing Objective-C++ SOURCE FILE Test ${VAR} succeded with the following output:\n"
        "${OUTPUT}\n"
        "Source file was:\n${SOURCE}\n")
    else()
