...
#include "cmAddLinkOptionsCommand.cxx"
...
#include "cmTargetLinkOptionsCommand.cxx"
  ...
  )
{
  ...
  commands.push_back(new cmAddLinkOptionsCommand);
  ...
  commands.push_back(new cmTargetLinkOptionsCommand);
